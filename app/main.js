...
const electron = require('electron'),
    ...
    configPath = proc.env.HOME + "/.config/ClassicManager-desktop-linux";
...
function create() {
    mainWindow = new electron.BrowserWindow({
        "icon": path.resolve(__dirname, "resources/cm-client-linux-x128.png"),
        "webPreferences": {
            'plugins': true
        }
    });

    mainWindow.loadURL('https://classicmanager.com');
    mainWindow.maximize();
